...
{
    public class Form7x_MakeData : DataMaker
    {
        ...
        public override List<Func<int>> GetDataFunc(DepartmentDescriptorBase info, DateTime fromDate, DateTime toDate)
        {
            ...
            DateTime startOfMonth = new DateTime(toDate.Year, toDate.Month, 1);
            ...
            result.Add(() => inDep.Where(s => s.Patient.Age <= 17).Count());
